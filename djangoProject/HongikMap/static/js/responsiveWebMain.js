...
let clubDic = {
    ...
    '스포츠분과': [["홍익태권", 418, 240], ["COWBOYS", 446, 240], ["HITTC", 558, 295], ["검도반", 482, 268], ["사격동아리", 213, 578], ["수영동아리", 537, 248], ["위너스", 546, 292], ["일레븐킥스", 434, 248], ["점프", 523, 282], ["HISC", 518, 280]],
    '전시분과': [["글샘문학회", 774, 359], ["모래알", 764, 359], ["미사랑", 527, 231], ["민화반", 769, 359], ["서우회", 779, 359]],
...
let clubText = {
    ...
    '하이러닝': ['하이러닝은 달리기를 좋아하는 홍익인들의 모임입니다.'],
    ...
    '파파': ['봉사의 가치와 즐거움을 만날 45년 전통의 동아리'],
    'HISC': ['새 친구 사귈 때, 스트레스 풀고 싶을 땐 사격동아리'],
